...
exports.updateAgentRequest = [
  ...
  body("company_name").notEmpty().withMessage("Company name is required"),
  body("company_address").notEmpty().withMessage("Company address is required"),
  body("contact_number").notEmpty().withMessage("Invalid phone number"),
  body("nid_number")
    .optional()
    .isString()
    .withMessage("NID number must be a string"),
  body("tin_number")
    .optional()
    .isString()
...
exports.validateCmsItem = [
  body("firstColor")
    .notEmpty()
    .isString()
    .withMessage("First color is required"),
  body("secondColor")
    .notEmpty()
    .isString()
    .withMessage("Second color is required"),
...
exports.validateResetPasswordData = [
  body("newPassword")
    ...
    .isLength({ min: 8, max: 12 })
    .withMessage(
      "Password is must be minimum 8 characters and maximum 12 characters"
    ),
  body("confirmPassword").custom((value, { req }) => {
...
exports.validateChangePasswordData = [
  ...
  body("newPassword")
    ...
    .isLength({ min: 8, max: 12 })
    .withMessage(
      "New password is must be minimum 8 characters and maximum 12 characters"
    ),
  body("confirmPassword").custom((value, { req }) => {
    if (value !== req.body.newPassword) {
      console.log(req.body.newPassword, req.body.confirmPassword);
...
exports.validateStaffCreation = [
  ...
  body("staff_designation")
    .notEmpty()
    .withMessage("Staff designation is required"),
  body("staff_phone").notEmpty().withMessage("Staff phone is required"),
  body("role")
    .notEmpty()
